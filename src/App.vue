                ...
                <div class="tabbar-icon-wrap">
                    ...
                    >
                        <path
                            ...
                            :stroke="active === 0 ? 'none' : '#959698'"
                            :stroke-width="active === 0 ? 0 : 2"
...
>
    <circle
        ...
        cy="12"
        r="10"
        :fill="active === 1 ? '#FFD600' : 'none'"
        :stroke="active === 1 ? 'none' : '#959698'"
        stroke-width="2"
    />
</svg>
<span>價差股利</span>
